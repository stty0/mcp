...
class MCPAIDiagramGenerator:
    ...
    def __init__(self, region: Optional[str] = None, workspace_dir: Optional[str] = None):
        ...
        self.server_params = StdioServerParameters(
            command="uv",
            args=["run", "python", "-m", "awslabs.aws_diagram_mcp_server.server"],
            env={
                "FASTMCP_LOG_LEVEL": "CRITICAL",  # Hide non-critical errors like sarif_om
                "PYTHONPATH": "/home/jrpark/workspace/mcp/src/aws-diagram-mcp-server"
            },
            cwd="/home/jrpark/workspace/mcp/src/aws-diagram-mcp-server"
        )
